...
namespace Rhyous.EntityAnywhere.Clients2.Common.Tests
{
    ...
    public class ExtensionEntityClientAsyncTests
    {
        ...
        #region GetDistinctExtensionPropertyValuesAsync
        [TestMethod]
        public async Task ExtensionEntityClientAsync_GetDistinctExtensionPropertyValuesAsync_Entity_Null()
        {
            // Arrange
            var extensionEntityClientAsync = CreateExtensionEntityClientAsync();
            string entity = null;
        ...
        [TestMethod]
        public async Task ExtensionEntityClientAsync_GetDistinctExtensionPropertyValuesAsync_Property_Null()
        {
            // Arrange
            var extensionEntityClientAsync = CreateExtensionEntityClientAsync();
            string entity = "User";
        ...
        [TestMethod]
        public async Task ExtensionEntityClientAsync_GetDistinctExtensionPropertyValuesAsync_Test()
        {
            // Arrange
            var extensionEntityClientAsync = CreateExtensionEntityClientAsync();
            string entity = "User";
