...
namespace Rhyous.EntityAnywhere.Clients2.Common.Tests
{
    ...
    public class EntityClientAsyncTests
    {
        ...
        public async Task EntityClientAsync_GetCountAsync_Url_ParamsNotEmpty_Test()
        {
            ...
            string actualUrl = "";
            string expectedUrl = "https://eaf.domain.tld/ThisService/EntityInts/Count?$filter=Contains(Name, abc)";
            _MockHttpClientRunner.Setup(m => m.RunAndDeserialize<int>(
                                   It.IsAny<HttpMethod>(),
                                   It.IsAny<string>(),
                                   It.IsAny<bool>()))
        ...
        public async Task EntityClientAsync_DeleteExtensionAllAsync_id_null()
        {
            ...
            await Assert.ThrowsExceptionAsync<ArgumentException>(async () =>
            {
                var result = await entityClientAsync.DeleteAllExtensionsAsync(id, extensionEntity, forwardExceptions);
            });
        }
        ...
        public async Task EntityClientAsync_DeleteExtensionAllAsync_Test()
        {
            ...
            Dictionary<TId, bool> extensionEntityIds = new Dictionary<TId, bool>();
            extensionEntityIds.Add(190, true);
            extensionEntityIds.Add(201, true);

            _MockHttpClientRunner.Setup(m => m.RunAndDeserialize<Dictionary<TId, bool>>(
                                               It.IsAny<HttpMethod>(),
                                               It.IsAny<string>(),
                                               It.IsAny<bool>()))
        ...
        public async Task EntityClientAsync_DeleteExtensionAsync_id_null()
        {
            ...
            await Assert.ThrowsExceptionAsync<ArgumentException>(async () =>
            {
                var result = await entityClientAsync.DeleteExtensionsAsync(id, extensionEntity, extentionEntityIds, forwardExceptions);
            });
        }
        ...
        public async Task EntityClientAsync_DeleteExtensionAsync_WithIds_Test()
        {
            ...
            _MockHttpClientRunner.Setup(m => m.RunAndDeserialize<object, Dictionary<TId, bool>>(
                                               It.IsAny<HttpMethod>(),
                                               It.IsAny<string>(),
