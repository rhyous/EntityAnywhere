...
namespace Rhyous.EntityAnywhere.Clients2
{
    ...
    public interface IEntityClientAsync : IEntityClientBase
    {
        ...
        /// </summary>
        /// <param name="id">The id of the entity.</param>
        /// <param name="entity">The entity to put, json serialized as a <see cref="JsonContent"/>.</param>
        ...
        /// <returns>True if deleted or if already deleted. False otherwise.</returns>
        Task<Dictionary<TId, bool>> DeleteAllExtensionsAsync<TId>(string id, string extensionEntity, bool forwardExceptions = true);
        ...
        /// <returns>True if deleted or if already deleted. False otherwise.</returns>
        Task<Dictionary<TId, bool>> DeleteExtensionsAsync<TId>(string id, string extensionEntity, IEnumerable<string> extensionEntityIds, bool forwardExceptions = true);
