...
namespace Rhyous.EntityAnywhere.Clients2
{
    public interface IExtensionEntityClientAsync : IEntityClientAsync
    {
        ...
        Task<List<string>> GetDistinctExtensionPropertyValuesAsync(string entity, string propertyName, bool forwardExceptions = true);
    }
        ...
        where TId : IComparable, IComparable<TId>, IEquatable<TId>
    {
        ...
        Task<OdataObjectCollection<TEntity, TId>> GetByPropertyValuePairsAsync(IEnumerable<PropertyValue> propertyValuePairs, bool forwardExceptions = true);
