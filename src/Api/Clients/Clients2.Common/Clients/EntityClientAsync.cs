...
namespace Rhyous.EntityAnywhere.Clients2
{
        ...
        where TId : IComparable, IComparable<TId>, IEquatable<TId>
    {
        ...
        public virtual async Task<int> GetCountAsync(string urlParameters, bool forwardExceptions = true)
            => await SendAsync<int>(HttpMethod.Get, $"{ServiceUrl}/{EntityPluralized}/Count", urlParameters, forwardExceptions);
        ...
        public virtual async Task<Dictionary<TId, bool>> DeleteAllExtensionsAsync(string id, string extensionEntity, bool forwardExceptions)
        {
            if (string.IsNullOrWhiteSpace(id)) { throw new ArgumentException($"The {nameof(id)} cannot be null, empty, or whitespace.", nameof(id)); }
        ...
        public virtual async Task<Dictionary<TId, bool>> DeleteExtensionsAsync(string id, string extensionEntity, IEnumerable<string> extensionEntityIds, bool forwardExceptions)
        {
            if (string.IsNullOrWhiteSpace(id)) { throw new ArgumentException($"The {nameof(id)} cannot be null, empty, or whitespace.", nameof(id)); }
            if (string.IsNullOrWhiteSpace(extensionEntity)) { throw new ArgumentException($"The {nameof(extensionEntity)} cannot be null, empty, or whitespace.", nameof(extensionEntity)); }
            if (extensionEntityIds == null || !extensionEntityIds.Any()) { throw new ArgumentException($"The {nameof(extensionEntityIds)} cannot be null, empty, or whitespace.", nameof(extensionEntityIds)); }
            var distinctValidIds = extensionEntityIds.Distinct();
