...
namespace Rhyous.EntityAnywhere.AutomatedTests
{
    public class PostEntityMetadataAttribute : Attribute, ITestDataSource
    {
        ...
        private static IEnumerable<KeyValuePair<string, CsdlEntity>> GetRelatedEntities(string entityName, CsdlEntity csdlEntity, IDictionary<string, object> entities)
        {
