...
namespace Rhyous.EntityAnywhere.Interfaces.Tests.Tools
{
    ...
    public class TokenDecoderTests
    {
        ...
        public void TokenDecoder_Decode_MultiUnitWithConcreteJWTToken_Test()
        {
            ...
            var role = WellknownUserRole.Customer;
            var roleId = WellknownUserRoleIds.Customer;
            var userRoleIdMap = new ConcurrentDictionary<string, int>();
            userRoleIdMap.TryAdd(role, roleId);
