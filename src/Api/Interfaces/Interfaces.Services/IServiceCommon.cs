...
namespace Rhyous.EntityAnywhere.Interfaces
{
        ...
        where TInterface : IId<TId>
    {
        ...
        /// <summary>
        /// Gets distinct values for a give property, after applying the optional expression.
        /// </summary>
        /// <param name="propertyName">The property.</param>
        /// <param name="preExpression">The optional expresion. Default is null.</param>
        /// <returns>Distinct values for a give property, after applying the optional expression.</returns>
        List<object> GetDistinctPropertyValues(string propertyName, Expression<Func<TEntity, bool>> preExpression = null);
        ...
        string GetPropertyValue(TId id, string property);
        ...
        /// <param name="id">The id of the entity.</param>
        /// <param name="property">The property to get the value from.</param>
        /// <param name="value">The new value as a stream.</param>
        /// <returns>The new value.</returns>
