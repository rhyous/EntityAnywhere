...
namespace Rhyous.EntityAnywhere.Repositories.Common.Tests.DependencyInjection
{
    ...
    public class DbModuleTests
    {
        ...
        private Mock<IEntityInfo<User>> _MockEntityInfo;
        ...
        public void TestInitialize()
        {
            ...
            _MockEntityInfo = _MockRepository.Create<IEntityInfo<User>>();
            ...
            builder.RegisterInstance(_MockEntityInfo.Object).As<IEntityInfo<User>>();
        ...
        [TestMethod]
        public void DbModule_IEntityConnectionStringProvider_IsRegistered()
        {
            Assert.IsNotNull(_Container.Resolve<IEntityConnectionStringProvider<User>>());
        }

        [TestMethod]
        public void DbModule_IEntityConnectionStringProvider_IsRegistered_Singleton()
        {
            Assert.AreEqual(_Container.Resolve<IEntityConnectionStringProvider<User>>(), _Container.Resolve<IEntityConnectionStringProvider<User>>());
        }
        ...
        public void DbModule_IBaseDbContext_IsRegistered()
        {
            using (var scope = _Container.BeginLifetimeScope(b =>
            {
                var mockEntityConnectionStringNameProvider = _MockRepository.Create<IEntityConnectionStringProvider<User>>();
                b.RegisterInstance(mockEntityConnectionStringNameProvider.Object).As<IEntityConnectionStringProvider<User>>();
