...
namespace Rhyous.EntityAnywhere.PluginLoaders
{
    ...
    public class EntityEventLoaderCommon<TEntity, TId> : RuntimePluginLoaderBase<IEntityEvent<TEntity, TId>>,
                                                         IEntityEventLoaderCommon<TEntity, TId>
        where TEntity : class, IId<TId>
    {
        private readonly ILogger _Logger2;

        public EntityEventLoaderCommon(IAppDomain appDomain,
        ...
        public override string PluginSubFolder => Path.Combine("Events", "Common");
