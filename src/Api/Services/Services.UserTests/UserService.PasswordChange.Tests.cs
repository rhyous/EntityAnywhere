...
namespace Rhyous.EntityAnywhere.Services.Tests
{
    public partial class UserServicePasswordInitializeTests
    {
        ...
        public async Task UserService_AddUserWillAutoCreatePasswordTest()
        {
            ...
            _MockServiceHandlerProvider.Setup(m => m.Provide<IAddAltKeyHandler<User, IUser, long, string>>()).Returns(_MockAddAltKeyHandler.Object);
        ...
        public void UserService_UpdateProperty_ChangeToIsHashedWillAutoCreateSaltAndHashPasswordTest()
        {
            ...
            _MockServiceHandlerProvider.Setup(m => m.Provide<IGetByIdHandler<User, IUser, long>>()).Returns(_MockGetByIdHandler.Object);
            _MockGetByIdHandler.Setup(m => m.Get(existingUser.Id)).Returns(existingUser);

            _MockServiceHandlerProvider.Setup(m => m.Provide<IUpdateAltKeyHandler<User, IUser, long, string>>()).Returns(_MockUpdateAltKeyHandler.Object);
