...
namespace Rhyous.EntityAnywhere.Services
{
                                       ...
                                       IUserService
    {
        ...
        public UserService(IServiceHandlerProvider serviceHandlerProvider,
        ...
        public override Task<List<IUser>> AddAsync(IEnumerable<IUser> users)
        {
            ...
            return _ServiceHandlerProvider.Provide<IAddHandler<User, IUser, long>>().AddAsync(users);
        }
        ...
        public override IUser Update(long id, PatchedEntity<IUser, long> patchedEntity)
        {
            ...
            return _ServiceHandlerProvider.Provide<IUpdateHandler<User, IUser, long>>().Update(id, patchedEntity);
        }
    }
}