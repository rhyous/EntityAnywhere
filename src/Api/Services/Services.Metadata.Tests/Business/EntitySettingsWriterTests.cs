...
namespace Rhyous.EntityAnywhere.Services.Tests.Business
{
    ...
    {
        [TestMethod]
        public async Task EntitySettingsWriter_Write_Test()
        {
            #region Arrange
            ...
            var entityWithMissingProperties = new EntityWithMissingProperties { Entity = entity, EntityGroup = entityGroup };
            ...
            var missingEntity = new Missing<EntityWithMissingProperties>(entityWithMissingProperties) { IsMissing = true };
        ...
        public void EntitySettingsWriter_UpdateEntityGroupIds_Test()
        {
            ...
            var entity = new Entity { Name = "E1" };
            var entityWithMissingProperties = new EntityWithMissingProperties { Entity = entity, EntityGroup = postedEntityGroup };
            var missingEntity = new Missing<EntityWithMissingProperties>(entityWithMissingProperties) { IsMissing = true };
            MissingEntitySettings settings = new MissingEntitySettings();
            settings.Entities.Add(entity.Name, missingEntity);
        ...
        public async Task EntitySettingsWriter_Write_Entities_Test()
        {
            ...
            var entity = new Entity { Name = "E1" };
            var entityWithMissingProperties  = new EntityWithMissingProperties { Entity = entity };
            var missingEntity = new Missing<EntityWithMissingProperties>(entityWithMissingProperties) { IsMissing = true };
            MissingEntitySettings settings = new MissingEntitySettings();
            settings.Entities.Add(entity.Name, missingEntity);
            ...
            // Assert
            Assert.AreEqual(postedEntity.Id, entityWithMissingProperties.Entity.Id);
            Assert.AreEqual(postedEntity.EntityGroupId, entityWithMissingProperties.Entity.EntityGroupId);
            mockEntityClient.Verify(m => m.PostAsync(It.IsAny<IEnumerable<Entity>>(), It.IsAny<bool>()), Times.Once);
            mockEntityPropClient.Verify(m => m.PostAsync(It.IsAny<IEnumerable<EntityProperty>>(), It.IsAny<bool>()), Times.Never);
            mockEntityGroupClient.Verify(m => m.PostAsync(It.IsAny<IEnumerable<EntityGroup>>(), It.IsAny<bool>()), Times.Never);
        }
        ...
        public void UpdateEntityProperties_StateUnderTest_ExpectedBehavior()
        {
            ...
            var mockLogger = new Mock<ILogger>();
            var entityGroup = new EntityGroup { Id = 301, Name = "G1", };
            var entity = new Entity { Name = "E1" };
            var entityWithMissingProperties = new EntityWithMissingProperties { Entity = entity, EntityGroup = entityGroup };
