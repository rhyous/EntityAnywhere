...
{
    public class GetByEntityIdentifiersHandler<TEntity, TInterface, TId>
        : IGetByEntityIdentifiers<TEntity, TInterface, TId>
        ...
        where TId : IComparable, IComparable<TId>, IEquatable<TId>
    {
        ...
        public GetByEntityIdentifiersHandler(IServiceCommon<TEntity, TInterface, TId> service,
