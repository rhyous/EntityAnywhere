...
namespace Rhyous.EntityAnywhere.WebServices.Common.Tests.Handlers
{
    ...
    public class GetByEntityIdentifiersTests
    {
        ...
        private GetByEntityIdentifiersHandler<TEntity, TInterface, TId> CreateGetByEntityIdentifiers()
        {
            return new GetByEntityIdentifiersHandler<TEntity, TInterface, TId>(
