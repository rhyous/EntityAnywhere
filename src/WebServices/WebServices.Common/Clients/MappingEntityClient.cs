...
namespace Rhyous.WebFramework.Clients
{
        ...
        where TE2Id : IComparable, IComparable<TE2Id>, IEquatable<TE2Id>
    {
        ...
        /// <inheritdoc />
        public virtual OdataObjectCollection<TEntity, TId> GetByE1Ids(IEnumerable<TE1Id> ids)
        {
            return GetByE1Ids(ids.ToList());
        }

        /// <inheritdoc />
        public virtual OdataObjectCollection<TEntity, TId> GetByE1Ids(List<TE1Id> ids)
        {
            return TaskRunner.RunSynchonously(GetByMappedEntityAsync, Entity1Pluralized, ids);
        }
        
        /// <inheritdoc />
        public virtual OdataObjectCollection<TEntity, TId> GetByE2Ids(IEnumerable<TE2Id> ids)
        {
            return GetByE2Ids(ids.ToList());
        }

        /// <inheritdoc />
        public virtual OdataObjectCollection<TEntity, TId> GetByE2Ids(List<TE2Id> ids)
        {
