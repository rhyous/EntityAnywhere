...
namespace Rhyous.WebFramework.Clients
{
        ...
        where TId : IComparable, IComparable<TId>, IEquatable<TId>
    {
        ...
        Task<List<OdataObject<TEntity, TId>>> GetAllAsync();
        ...
        Task<List<OdataObject<TEntity, TId>>> GetByQueryParametersAsync(string queryParameters);
        ...
        Task<List<OdataObject<TEntity, TId>>> GetByIdsAsync(List<TId> ids);
        ...
        Task<List<OdataObject<TEntity, TId>>> PostAsync(List<TEntity> entity);
        ...
        Task<List<OdataObject<TEntity, TId>>> GetByCustomUrlAsync(string url);
        ...
        /// <returns>A list of entities returned by the custom service.</returns>
        Task<List<OdataObject<TEntity, TId>>> GetByCustomUrlAsync(string urlPart, Func<string, HttpContent, Task<HttpResponseMessage>> httpMethod, HttpContent content);
        ...
        /// <returns>A list of entities returned by the custom service.</returns>
        Task<List<OdataObject<TEntity, TId>>> GetByCustomUrlAsync(string urlPart, Func<string, HttpContent, Task<HttpResponseMessage>> httpMethod, object content);
        #endregion
    }
}
