...
{
    using EntityInterface = IAddendum;

    public static class AddendaExtensions
    {
        /// <summary>
        /// Takes a concrete class acting as EntityInterface and converts it to act as type T.
        /// </summary>
        ...
        public static T Get<T>(this IEnumerable<EntityInterface> addenda, string entity, string entityId, string property, T defaultValue)
        {
