...
namespace Rhyous.EntityAnywhere.AutomatedTests
{
    ...
    public class UserTests
    {
        ...
        public EntityClientConnectionSettings _Settings;
        ...
        public void TestInitialize()
        {
            ...
            _Settings = new EntityClientConnectionSettings("User", EntityClientConfig);
        }
        ...
        {
            // Arrange
            var client = new AdminEntityClientAsync(_Settings, _AdminHttpClientRunner);

            // Act
            var json = await client.GetByCustomUrlAsync("$GenerateRepository");
        ...
        {
            // Arrange
            var client = new EntityClientAsync(_Settings, _AdminHttpClientRunner);
        ...
        public async Task EAF_User_GetAsync_ById_ApiTest()
        {
            ...
            var stringContentToPost = new StringContent(userJsonToPost);
        ...
        public async Task EAF_User_PostExtensionAsync_ById_ApiTest(string extensionEntity)
        {
            // Arrange
            var client = new EntityClientAsync(_Settings, _AdminHttpClientRunner);
            var userJsonToPost = $"[{{\"Username\":\"ApiTestUser_{DateTime.Now.ToString(DateTimeFormat)}\",\"Enabled\":false,\"ExternalAuth\":false,\"IsHashed\":false,\"OrganizationId\":1,\"Password\":\"pw\",\"Salt\":null}}]";
            ...
            var resultJson = await client.PostExtensionAsync(id, extensionEntity, json);
        ...
        public async Task EAF_User_POST_1_ApiTest()
        {
            ...
            var stringContent = new StringContent(userJson);
        ...
        public async Task EAF_User_POST_2_ApiTest()
        {
            ...
            var stringContent = new StringContent(twoUserJson);
        ...
        public async Task EAF_User_Put_ApiTest()
        {
            ...
            var stringContentToPut = new StringContent(userJsonToPut);
        ...
        public async Task EAF_User_Patch_ApiTest()
        {
            ...
            var stringContentToPatch = new StringContent(userJsonToPatch);
        ...
        public async Task EAF_User_PatchMany_ApiTest()
        {
            ...
            var stringContentToPatchMany = new StringContent(usersPatchJson);
