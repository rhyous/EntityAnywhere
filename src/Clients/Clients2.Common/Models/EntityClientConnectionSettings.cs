...
namespace Rhyous.EntityAnywhere.Clients2
{
    ...
    public partial class EntityClientConnectionSettings : IEntityClientConnectionSettings
    {
        ...
        public virtual string ServiceUrl => string.IsNullOrEmpty(Config.EntitySubpath) ? StringConcat.WithSeparator('/', Config.EntityWebHost, $"{EntityName}Service.svc") : StringConcat.WithSeparator('/', Config.EntityWebHost, Config.EntitySubpath, $"{EntityName}Service.svc");
