...
describe('EntityMetadataService', () => {
  ...
  it('should parse the metadata from localstorage and return an object', () => {
    ...
    // Assert
    expect(response).not.toEqual(<any>null)
  ...
  it('should get a single table from local storage and supply an object', () => {
    ...
    // Act
    const response = service.getEntityMetaData('AlternateId')
  ...
  it('should return entity metadata', () => {
    // Arrange
    const entity = {key: 'AuthenticationAttempt', value: Fake.FakeMeta}
    ...
    expect(md.Name).toEqual('AuthenticationAttempt')
  })
