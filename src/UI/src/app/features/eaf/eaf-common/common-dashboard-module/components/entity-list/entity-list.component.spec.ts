...
describe('Entity List Component', () => {
  ...
  beforeEach(() => {
    component.metaDataObject = {
      ...
      isMappingEntityType: false,
      isOfEntityType: (entityType) => {
        return false
      },
    }
  })
  ...
  it('should create', () => {
    spyOn(component, 'initialise').and.returnValue(<any>null)
  ...
  it ('Should change a page of results', () => {
    spyOn(component, 'updateGridData').and.returnValue(<any>null)
  ...
  it ('Should navigate to entity details page', () => {
    ...
    expect(mockRouter.navigate).toHaveBeenCalledWith(['./admin/data-administration/SuiteMembership/4'])
  })
  ...
  it ('Should process the delete calls successfully', () => {
    ...
    .toHaveBeenCalledWith( 'The suitememberships were successfully deleted', <any>null, Object({ duration: 10000 }) )
    expect(component.updateGridData).toHaveBeenCalledWith(true)
  ...
  it ('Should process the delete calls failure', () => {
    ...
    expect(entityService.deleteEntity).toHaveBeenCalledTimes(2)
    expect(component.snackBar.open)
    .toHaveBeenCalledWith( 'There was an issue deleting the selected suitememberships',
     <any>null, Object({ duration: environment.snackBarDuration }) )
    expect(component.updateGridData).toHaveBeenCalledTimes(0)
  })

  it ('Should navigate to a create new page', () => {
    component.createNew()
    expect(mockRouter.navigate).toHaveBeenCalledWith(['./admin/data-administration/SuiteMembership/add'])
  })
  ...
  it ('should update the grid data with fresh entity data', () => {
    spyOn(storageService, 'storeFilterSettings').and.returnValue(<any>null)
    spyOn(component, 'getEntityList').and.returnValue(<any>null)
  ...
  it('should call the server if there is no latest response or no entities in the latest response', () => {
    // Arrange
    spyOn(component, 'filterWithServer').and.returnValue()
    component.latestEntityListResponse = <any>undefined
  ...
  it('should update the latest response, call updateDataSource and set the progressbar to false', () => {
    ...
    spyOn(component, 'updateDatasource').and.returnValue(<any>null)
    component.filterSettings.PageSize = 100
