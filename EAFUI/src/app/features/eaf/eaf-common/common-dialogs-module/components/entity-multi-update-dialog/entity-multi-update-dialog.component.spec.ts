...
describe('EntityMultiUpdateDialogComponent', () => {
  ...
  it('should confirm update dialog on submit', () => {
    spyOn(component, 'getPatchEntityCollection').and.returnValue(null)
  ...
  it('should return updated fields to patch', () => {
    ...
    const requestObj = component.getPatchEntityCollection(formFields)
  ...
  it('should display success message on successful update', () => {
    spyOn(entityService, 'patchManyEntities').and.returnValue(of(null))
  ...
  it('should handle an error on update', () => {
    const errorMessage = {status: 500, Acknowledgable: false}
    ...
    component.updateRecords(null)
    expect(errorReporter.displayMessage).toHaveBeenCalledWith(errorMessage)
  })
