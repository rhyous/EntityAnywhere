...
export class EntitySearcherDialogComponent extends CommonDialogBaseComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<EntitySearcherDialogComponent>,
  ...
  rowClick(row: any) {
    const displayName = this.metaData.UIDisplayName['$PropertyPath']
      ? this.metaData.UIDisplayName['$PropertyPath']
